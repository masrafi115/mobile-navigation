...
class ScopeDescriptorHelper {
  ...
  getClassListForBufferPosition(editor, bufferPosition, climbCount) {
  ...
  getStartOfClassListAtPosition(editor, classList, bufferPosition, climbCount) {
  ...
  getEndOfClassListAtPosition(editor, classList, bufferPosition, climbCount) {
...
export default ScopeDescriptorHelper